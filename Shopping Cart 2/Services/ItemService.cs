...
namespace Shopping_Cart_2.Services
{
    public class ItemService : IItemService
    {
        ...
        public ItemService(ApplicationDbContext context, IWebHostEnvironment webHostEnvironment, UserManager<ApplicationUser> userManager, IHttpContextAccessor httpContextAccessor, IRatingService ratingService)
        {
            _context = context;
